<?php
/**
 * View Template: Home Products Carousel
 *
 * ...
 *
...
$query = vb_loop_query( $view_id );
 ...
 ?>
 	...
 	<?php if ( $query->have_posts() ) : ?>
 		...
 		<div id="view-<?php echo $view_id; ?>" class="carousel product-view">
 		...
 		<?php while( $query->have_posts() ) : $query->the_post(); ?>
 			...
 			<article id="post-<?php the_ID(); ?>" class="article-<?php echo views()->count; ?> article item clearfix hentry">
 				...
 				<div class="article-inner">
					...
					<?php echo do_shortcode('[vb_wc_price before="From: "]'); ?>
 					<?php echo do_shortcode('[vb_image thumbnail_width="500" thumb_cover_type="flip"]'); ?>
