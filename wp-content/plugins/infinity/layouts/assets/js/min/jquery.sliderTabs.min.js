 ...
 (function( $ ){
	...
	$.sliderTabs = function(container, options){
		...
		plugin.init = function(){
			...
			// Tab arrows
			$leftTabArrow = $("<a href='#' class='ui-slider-left-arrow slider-arrow left'><div></div></a>").css({
			...
			$rightTabArrow = $("<a href='#' class='ui-slider-right-arrow slider-arrow right'><div></div></a>").css({
				'width': settings.tabArrowWidth,
				'height': settings.tabHeight+2
			}).appendTo($tabsListContainer).click(function(e){
			...
			if($indicators)
				$indicators.delegate('.ui-slider-tabs-indicator', 'click', function(event){
		...
		plugin.showIndicators = function(){
			if(!$indicators){
				$indicators = $("<ul class='ui-slider-tabs-indicator-container'>");
				for(var i = 0; i < $contentDivs.length; i++){
					$indicators.append("<li class='ui-slider-tabs-indicator'><a href='#'></a></li>");
				}
		...
		var selectIndicator = function(){
			if(settings.indicators && $indicators){
				var $indicator = $indicators.children("li:nth-child("+plugin.selectedTab+")");
		...
		var positionPanelArrows = function(){
			if(settings.panelArrows){
				...
				if(!$leftPanelArrow && !$rightPanelArrow){
					$leftPanelArrow = $("<div class='ui-slider-tabs-panel-arrow panel-arrow left'>").click(function(){
						plugin.prev();
					});
					$rightPanelArrow = $("<div class='ui-slider-tabs-panel-arrow panel-arrow right'>").click(function(){
						plugin.next();
					});
