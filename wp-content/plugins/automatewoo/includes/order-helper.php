...
class AW_Order_Helper
{
	...
	function __construct()
	{
		...
		add_action( 'woocommerce_api_create_order', [ $this, 'set_user_last_order_meta' ], 1000 );
		add_action( 'woocommerce_checkout_order_processed', [ $this, 'set_user_last_order_meta' ], 1000 );
	 ...
	 * @return AW_Model_Order_Guest|WP_User
	 */
	 ...
	 * @param $order_id
	 */
	function set_user_last_order_meta( $order_id )
	{
