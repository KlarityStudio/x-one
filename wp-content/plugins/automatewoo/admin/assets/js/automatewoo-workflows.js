	...
	AutomateWoo.Workflows = {
		...
		fill_trigger_fields: function( trigger_name ) {
			...
			if ( trigger_name ) {
				...
				AutomateWoo.Workflows.$triggers_box.addClass('loading');
				...
				$.ajax({
					...
					.done(function(response){
						...
						AutomateWoo.Workflows.$triggers_box.removeClass('loading');
		...
		fill_action_fields: function( $action, selected_action ) {
			...
			AutomateWoo.Workflows.$actions_box.addClass('loading');
			...
			$.ajax({
				...
				.done(function(response){
					...
					AutomateWoo.Workflows.$actions_box.removeClass('loading');
