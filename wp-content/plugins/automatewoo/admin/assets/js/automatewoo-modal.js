...
jQuery(function($) {
    ...
    AutomateWoo.Modal = {
        ...
        open: function( classes ) {
            ...
            $(document.body).append('<div class="automatewoo-modal ' + classes + '"><div class="automatewoo-modal-contents"><div class="automatewoo-modal-header"></div></div><div class="automatewoo-icon-close js-close-automatewoo-modal"></div></div>');
            this.position();
        },
        ...
        contents: function ( contents ) {
            ...
            $('.automatewoo-modal-contents').html(contents);
        ...
        position: function() {
            ...
            $('.automatewoo-modal-body').removeProp('style');

            var modal_header_height = $('.automatewoo-modal-header').outerHeight();
            var modal_height = $('.automatewoo-modal').height();
            var modal_width = $('.automatewoo-modal').width();
            var modal_body_height = $('.automatewoo-modal-body').outerHeight();
            ...
            if ( modal_height < modal_contents_height - 5 ) {
                $('.automatewoo-modal-body').height( modal_height - modal_header_height );
            }
        }
