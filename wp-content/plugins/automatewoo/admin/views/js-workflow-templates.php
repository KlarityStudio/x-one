<script id="tmpl-aw-trigger-compatibility-modal" type="text/template">
	<div class="automatewoo-modal-header">
		<h1><?php esc_attr_e('Confirm change trigger?', 'automatewoo') ?></h1>
	</div>

	<div class="automatewoo-modal-body">
		<div class="automatewoo-modal-body-inner">
	...
	<div class="automatewoo-modal-footer aw-pull-right">
