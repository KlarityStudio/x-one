		...
		<tbody>
			...
			<tr class="aw-field-row js-trigger-options-queueing">
				<td class="aw-input">
					...
					<label>Run Actions <img class="tips" data-tip="<?php echo __( "Use this to delay actions being run by a set period of time after the initial trigger event. These queued events are visible in the WooCommerce Reports section.", 'automatewoo' ) ?>" src="<?php echo WC()->plugin_url() ?>/assets/images/help.png"></label>
			...
			<tr class="aw-field-row js-require-email-tracking">
				<td class="aw-input">
					...
					<label>Enable Conversion Tracking <img class="tips" data-tip="<?php echo __( "Check to enable conversion tracking on purchases. Reports will be visible on the WooCommerce Reports page.", 'automatewoo' ) ?>" src="<?php echo WC()->plugin_url() ?>/assets/images/help.png"></label>
					<?php
					$field = new AW_Field_Checkbox();
					$field
						->set_name_base('aw_workflow_data[workflow_options]')
