		...
		<tbody>
			...
			<tr class="aw-field-row" data-name="trigger_name" data-type="select" data-required="1">
				<td class="aw-label">
					...
					<label><?php echo __( 'Trigger Type', 'automatewoo' ) ?><span class="required">*</span></label>

					<img class="tips" data-tip="<?php echo __('Select a trigger type to view the options fields.', 'automatewoo') ?>" src="<?php echo WC()->plugin_url() ?>/assets/images/help.png" height="16" width="16">
